      ...
      <header className="border-b border-border bg-card">
        <div className="mx-auto flex max-w-6xl items-center justify-between gap-4 px-4 py-3">
          <div>
            ...
            <h1 className="font-display text-lg font-bold text-foreground">Reservasi — Admin</h1>
          </div>
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="w-full max-w-sm rounded-2xl border border-border bg-card p-6 shadow-md">
        ...
        <h1 className="mb-5 font-display text-xl font-bold text-foreground">Masuk Admin</h1>
